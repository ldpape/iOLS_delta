...
* 20/04 : quiet collinearity, SHOW eps option.
...
syntax varlist [if] [in] [aweight pweight fweight iweight] [, DELta(real 1) from(name) endog(varlist) instr(varlist) SHOW LIMit(real 1e-8)  MAXimum(real 10000) Robust CLuster(string)]           
