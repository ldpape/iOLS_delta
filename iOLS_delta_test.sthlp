...
{phang2}{cmd:. xi: eststo reg1: iOLS_delta trips cbd ptn worker i.weekend tcost, delta(1) robust }{p_end}
{phang2}{cmd:. xi: bootstrap lambda_stat=e(lambda) ,    reps(50):  iOLS_delta_test trips cbd ptn worker i.weekend tcost , delta(1) nonparametric  }{p_end}
